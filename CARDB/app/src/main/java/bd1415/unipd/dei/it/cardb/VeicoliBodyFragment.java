...
public class VeicoliBodyFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (mIsVis) {
            mImage = (ImageView) activity.findViewById(R.id.image_veicoli);
            mBody = (LinearLayout) MainActivity.act.findViewById(R.id.ll_veicoli);
            mImage.setVisibility(View.GONE);
            mBody.setVisibility(View.VISIBLE);
        }
        viewHolder.targa = (TextView) activity.findViewById(R.id.veicolo_targa_data);
        viewHolder.numero_telaio = (TextView) activity.findViewById(R.id.veicolo_telaio_data);
        viewHolder.proprietario = (TextView) activity.findViewById(R.id.veicolo_proprietario_data);
        viewHolder.marca = (TextView) activity.findViewById(R.id.veicolo_modello_marca_data);
        viewHolder.modello = (TextView) activity.findViewById(R.id.veicolo_modello_nome_data);
        viewHolder.anno_modello = (TextView) activity.findViewById(R.id.veicolo_modello_anno_data);
        viewHolder.lavorazioni = (ListView) activity.findViewById(android.R.id.list);
