...
public class PagamentiFattiMenuFragment extends ListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        adp = new PagamentiArrayAdapter(inflater.getContext(), ApplicationData.fatturePagate);
    ...
    public void onListItemClick(ListView list, View v, int pos, long id) {
        ...
        if (isLarge) {
            ...
            Fragment toView = new PagamentiFattiBodyFragment();
            ...
            ft.replace(R.id.pagamenti_fatti_body, toView);
